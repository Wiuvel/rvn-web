...
export default function BannerUploadModal({
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-neutral-900 border border-white/10 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col pointer-events-auto"
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6">
            ...
            {/* Рекомендации по размеру баннера */}
            <div className="mb-6 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
              <p className="text-xs text-blue-200/80">
                Рекомендуемый размер: <span className="text-blue-300 font-medium">1200×300px</span> (соотношение 4:1).
              </p>
            </div>
